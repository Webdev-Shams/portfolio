        ...
        async function fetchData() {
            try {
                ...
                if (res.ok) {
                    ...
                    setFormData({
                        ...data,
                        techStack: (data.techStack as string[]).join(", "),
    ...
    return (
        <div className="fade-in" style={{ maxWidth: "800px" }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                ...
                <button onClick={handleSubmit} disabled={saving} style={{ background: 'var(--color-accent)', color: '#000', border: 'none', padding: '10px 24px', borderRadius: '6px', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                    <Save size={18} /> {saving ? "Updating..." : "Update Record"}
                </button>
            </div>
